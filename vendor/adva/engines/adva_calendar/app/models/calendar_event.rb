...
class CalendarEvent < ActiveRecord::Base
  ...
  is_indexed :fields => ['created_at', 'body_html'],
             :concatenate => [
               {:class_name => 'Section', :field => 'sections.site_id', :as => 'site_id', :association_sql => 'inner join sections on calendar_events.section_id = sections.id'}
              ]
