      ...
      define do
        ...
        menu :left, :class => 'main' do
          ...
          if @site && !@site.new_record?
            ...
            item :playlists,     :action => :index, :resource => [@site, :playlist] if Rails.plugins.include?(:lico_adva_playlists)
            item :conferences,   :action => :index, :resource => [@site, :conference] if Rails.plugins.include?(:yp_bigbluebutton)
          end
        end
